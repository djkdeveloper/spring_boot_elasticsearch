...
public class EsSearchRequest {
     ...
     * 索引名称
     */
    private String indexName = "es_product_index";

    /**
     * 类型
     */
    private String type = "esProduct";
    ...
    public BoolQueryBuilder buildBoolQueryBuilder() {
        ...
        // 上架过滤
        this.addshelvesStatusFilter(boolQueryBuilder);
     ...
     * @param boolQueryBuilder bool 查询
     */
    public void addshelvesStatusFilter(BoolQueryBuilder boolQueryBuilder) {
    ...
    private void addNameQuery(BoolQueryBuilder boolQueryBuilder) {
        ...
        boolQueryBuilder.must(QueryBuilders.matchQuery("pname", this.queryString));
    }
